            ...
            if not improved:#mogelijk verbeteren
                ...
                if max((dfbez.loc[cot_id2-1][t]))==0:
                    ...
                    if is_val_swap(start_res,cot_id2):
                        ...
                        tussenscore = s1 - s2
                        #print(tussenscore)
                        if tussenscore > tussenscore_def:
                            tussenscore_def = tussenscore
                            wissel = cot_id2                      
                        swap(start_res,cot_id2,0,cot_id1)
        #print(tussenscore_def)
        #print(cot_id1, 'en', wissel)
        if tussenscore_def > 0:
            swap(start_res,cot_id1,0,wissel)
        tussenscore_def = 0
